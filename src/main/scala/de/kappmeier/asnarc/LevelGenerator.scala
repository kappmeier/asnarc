...
import de.kappmeier.asnarc.elements.{Element, Wall}

import scala.collection.immutable.{HashMap, Set}
import scala.collection.mutable

/**
  * A factory that can create [[SnakeGame]] boards to be used to play. The levels are defined in a text definition, either
